...
//
//    public Optional<List<StoolRecordResponse>> getStoolRecord(Long babyCareTrackerId) {
//        Optional<List<StoolRecord>> stoolRecordOptional = stoolRecordRepository.findByFkTrackerId(babyCareTrackerId);
//
